...
const tr: Dict = {
  ...
  ui: {
    ...
    form: {
      ...
      message: "Mesaj",
      send: "Mesajı Gönder",
      sentTitle: "Teşekkürler! Mesajınız hazır.",
      sentBefore:
        "Bu bir demo iletişim formudur; gönderim henüz bir servise bağlı değildir. Size en kısa sürede dönebilmem için",
      sentAfter: "adresinden de yazabilirsiniz.",
...
const en: Dict = {
  ...
  ui: {
    ...
    form: {
      ...
      message: "Message",
      send: "Send Message",
      sentTitle: "Thanks! Your message is ready.",
      sentBefore:
        "This is a demo contact form; submission is not wired to a service yet. So I can get back to you quickly, you can also email me at",
      sentAfter: ".",
